                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              (arg.userData.enableOutstationRoundTripFeature ==
                                      '1')
                                  ? Theme.of(context)
                                      .disabledColor
                          ...
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    border: !bookingBloc.isRoundTrip
                                        ? Border.all(
                        ...
                        InkWell(
                          ...
                          child: Row(
                            children: [
                              ...
                              if (bookingBloc.showReturnDateTime.isEmpty) ...[
                                MyText(
                                  text:
                  ...
                  : RawScrollbar(
                      child: ListView.builder(
                        ...
                        itemCount: bookingBloc.isMultiTypeVechiles
                            ? bookingBloc.sortedEtaDetailsList.length
                            : bookingBloc.etaDetailsList.length,
                        itemBuilder: (context, index) {
                          final eta = bookingBloc.isMultiTypeVechiles
                              ? bookingBloc.sortedEtaDetailsList
                                  .elementAt(index)
                              : bookingBloc.etaDetailsList.elementAt(index);
                          return InkWell(
                            onTap: () {
